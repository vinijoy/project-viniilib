...
<form enctype="multipart/form-data" action="process_create.php" method="POST">
      <input type="hidden" name="gbn" value="<?=$bo_gbn?>">
      <p><input type="text" class="title" name="title" placeholder="제목" required></p>
<p id="titleCounter">입력한 글자수: 0자</p>
      <p><textarea class="description" name="description" placeholder="내용"></textarea></p>
<p id="descriptionCounter">입력한 글자수: 0자</p>
 <input type="file" name="myfile" id="myfile">
<p>업로드 가능한 확장자: mp3, wav, m4a, html, php, js, txt, zip</p>
<p><textarea name="media" placeholder="미디어(iframe태그로 유튜브 영상 삽입)"></textarea></p>
